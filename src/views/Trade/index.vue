<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="detail">
        <h5>商品清单</h5>
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.sukid">
          <li>
...
import {mapState, mapGetters} from 'vuex'
  export default {
    ...
    computed: {
      // 这里我用两种不同的方法去拿到仓库中的数据
      ...mapGetters(['userAddressList']),
      ...mapState({
        orderInfo: state => state.trade.orderInfo
      }),
      // 将选中的默认地址写成一个计算属性，支付的时候也要用到
      defaultUserAddress() {
        // find方法，将数组中符合条件的元素返回(这里就是将选中的那个用户的整个对象返回)
