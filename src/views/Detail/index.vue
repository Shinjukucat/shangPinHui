    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果，这里后面传过去的skuImageList是计算属性-->
...
export default {
  ...
  computed: {
    ...mapGetters(['categoryView', 'skuAttrValueList', 'skuInfo', 'spuSaleAttrList']),
    // 和store里面解决的问题是同一个根源，都是由于请求数据消耗事件，在请求到数据之前返回的那个空数组导致的一系列问题，在一开始时skuInfo返回的是空数组，你现在在下面找skuImageList属性肯定是undefined
    skuImageList() {
      // 所以，当拿到skuInfo数据后再把数据返回，拿到的是空对象的时候返回空数组，至少不会报undefined的错误
